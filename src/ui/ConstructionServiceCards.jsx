...
const serviceCards = [
    {
        ...
        description:
            "Custom home building and renovation services tailored to your unique vision and needs.",
    },
    {
        id: 2,
        icon: <BsBuildings />,
        ...
        description:
            "Large-scale commercial projects delivered with precision and efficiency.",
    },
    {
        id: 3,
        icon: <FaHelmetSafety />,
        ...
        description:
            "Specialized solutions for complex industrial projects with strict safety and quality standards.",
    },
    {
        id: 4,
        icon: <TiSpanner />,
        ...
        description:
            "Comprehensive project management services to ensure timely and budget-conscious delivery of construction projects.",
    },
];
